...
export default function LabelDesign() {
  return (
    <div className="bg-gray-100 min-h-screen ">
      <Navbar />
      <h1 className="text-4xl font-bold text-black text-left mb-2 mt-5 mx-4">Label Design Services</h1>
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-4 mx-4 text-left">Label Design Process</h2>
