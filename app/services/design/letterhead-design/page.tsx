...
export default function LetterheadDesign() {
  return (
    <div className="bg-gray-100 min-h-screen ">
      <Navbar />
      <h1 className="text-4xl font-bold text-black text-left mb-2 mt-5 mx-4">Letterhead Design Services</h1>
 ...
 <RecentProjects serviceFolder="letterhead" title="Letterhead" />
      <h2 className="text-2xl font-bold text-gray-900 mb-4 text-left mx-4">Letterhead Design Process</h2>
