...
export default function BookCoverPrint() {
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <Navbar />
      <h1 className="text-4xl font-bold text-black text-left mb-2 mt-5">Book Cover Printing Services</h1>
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-4 text-left">Our Book Cover Printing Process</h2>
