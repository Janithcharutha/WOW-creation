...
export default function BannerPrint() {
  return (
    <div className="bg-gray-100 min-h-screen ">
      ...
      <Navbar />
      <h1 className="text-4xl font-bold text-black text-left mb-2 mt-5 mx-4">Banner Printing Services</h1>
      ...
      <HotDeals serviceFolder="bannersprint" title="Banner Printing" />
      <RecentProjects serviceFolder="bannersprint" title="Banner Printing" />
      <h2 className="text-2xl font-bold text-gray-900 mb-4 text-left mx-4">Our Banner Printing Process</h2>
